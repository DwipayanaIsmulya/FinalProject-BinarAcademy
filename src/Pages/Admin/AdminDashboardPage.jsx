      ...
      <div className="flex h-screen w-full">
        ...
        <div className="bg-[#6148FF] flex-initial w-[400px]">
          <div className="flex flex-col text-white">
            ...
            <button className="text-start font-bold py-5 pl-6 mt-2 bg-[#489CFF] ">
              Dashboard
            </button>
            <button
              onClick={() => navigate("/adminkelolakelas")}
              className="text-start font-bold py-5 pl-6 mt-2 hover:bg-[#489CFF] duration-500"
            >
              Kelola Kelas
            </button>
            <button className="text-start font-bold py-5 pl-6 mt-2 hover:bg-[#489CFF] duration-500">
              Keluar
            </button>
          </div>
        </div>
        ...
        <div className="flex-initial w-full">
          ...
          <div className="bg-[#EBF3FC] py-6 grid grid-cols-2 ">
            <div className="py-4 pl-16 text-2xl font-bold text-[#6148FF]">
              Hi, Admin!
            </div>
            <div className="text-end my-auto px-16">
              <input
                type="text"
                className="p-3 my-3 w-[200px] rounded-xl text-black md:mx-2 sm:mx-2"
                placeholder="Cari.."
              />
            </div>
          </div>
          ...
          <div className="flex flex-col px-16">
            <div className="grid grid-cols-2 ">
              ...
              <div className="flex justify-end">
                <button className=" bg-[#6148FF] text-white rounded-2xl px-5 mx-2 border-2 border-black hover:bg-white hover:text-[#6148FF] duration-150">
                  Tambah
                </button>
                <button className=" bg-[#6148FF] text-white rounded-2xl px-5 mx-2 border-2 border-black hover:bg-white hover:text-[#6148FF] duration-150">
                  Filter
