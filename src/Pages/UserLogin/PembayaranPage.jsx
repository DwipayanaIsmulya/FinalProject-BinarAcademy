                ...
                <div className={`${toggleCreditCard ? "rounded-xl border-b-2 h-full p-4 md:h-[370px]" : "hidden"}`}>
                  <div className="w-[100%]">
                    <div>
                      ...
                      <div>
                        <input className="mb-4 py-2 px-2 pr-24 border-b-2" type="text" placeholder="4480 0000 0000 0000" />
                      </div>
                    </div>
                    <div>
                      <div className="font-medium">Card Holder Name</div>
                      <div>
                        <input className="mb-4 py-2 px-2 pr-24 border-b-2" type="text" placeholder="John Doe" />
                      </div>
                    </div>
                    <div className="flex">
                      <div>
                  ...
                  <div className=" mx-auto">
                    ...
                    <div className="flex justify-between md:justify-around">
                      ...
                      <div className="pt-3">
                        ...
                        <div className="text-[#6148FF] font-bold">Rp 387,390</div>
                      </div>
                    </div>
                    <div className="py-3">
